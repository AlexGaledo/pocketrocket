...
/** lucide-react 1.x dropped brand icons, so the GitHub mark is drawn here like Google's. */
function GithubMark() {
  return (
    <svg aria-hidden viewBox="0 0 16 16" width="15" height="15" fill="currentColor">
